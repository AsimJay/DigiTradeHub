...
<section class="checkout-orders">
   ...
   <h3>Your Orders</h3>
      ...
      ?>
         ...
         <div class="grand-total">Grand Total : <span><?= $grand_total; ?> PKR/-</span></div>
      </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method" class="box" required>
               <option value="cash on delivery">SadaPay</option>
               <option value="cash on delivery">Via Whatsapp</option>
               <option value="credit card">Credit Card</option>
               <option value="paytm">Easypaisaa</option>
